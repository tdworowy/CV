...
\large
Software tester, adherent of context driven testing school, specialize in test automation (functional and performance) mostly using Python (scripting, data validation, api testing, web application testing with selenium) and Cypress. Professionally interested in DevOps, hacking and programming, personally in history, philosophy and economics. //TODO rewrite
\par 
\noindent\makebox[\linewidth]{\rule{\paperwidth}{1pt}}

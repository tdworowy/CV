...
#### Project:
Services responsible for logs gathering and firmware updates for Tivo OS - smart TV operating system. 
...
### Project:
Cirrus Revenue Operating System - revenue management and forecasting system for airlines. 
...
### Project:
Data pipeline - goal of project was to prepare data pipeline from salesforce to AWS S3 bucket and transformation of data to made it ready to use in ThoughtSpot.

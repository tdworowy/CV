...
Software tester, adherent of context driven testing school, specialize in test automation.
Professionally interested in DevOps, data science and machine learning, personally in history, philosophy and economics.   
...
```{r Programing, echo=FALSE, fig.cap="Programing languages", out.width = '100%'}
knitr::include_graphics("programing.png")
```
\newpage
#  Skills
```{r skills, echo=FALSE, fig.cap="Skills", out.width = '100%'}
knitr::include_graphics("skills.png")
```
\newpage

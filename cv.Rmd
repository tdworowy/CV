...
\large
Software tester, adherent of context driven testing school, specialize in test automation (functional and performance) mostly using Python (scripting, data validation, api testing, web application testing with selenium) and Cypress. Professionally interested in DevOps, hacking and programming, personally in history, philosophy and economics. 
\par 
\noindent\makebox[\linewidth]{\rule{\paperwidth}{1pt}}
...
labs <- c("Hacking", "DevOps","Exploratory testing", "Test automation")
scores <- list(
  "Sklis" = c(4, 6, 9, 9)
